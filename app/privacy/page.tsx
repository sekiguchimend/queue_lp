...
export const metadata: Metadata = {
  title: "個人情報保護方針 | Queue株式会社",
  description: "Queue株式会社の個人情報保護方針（プライバシーポリシー）。個人情報の収集・利用目的・第三者提供・安全管理・開示請求等について定めています。",
  alternates: {
    canonical: "/privacy",
  },
  openGraph: {
    title: "個人情報保護方針 | Queue株式会社",
    description: "Queue株式会社の個人情報保護方針（プライバシーポリシー）。個人情報の収集・利用目的・第三者提供・安全管理・開示請求等について定めています。",
    url: "https://queue-tech.jp/privacy",
    type: "website",
    images: [{
  ...
  twitter: {
    card: "summary",
    title: "個人情報保護方針 | Queue株式会社",
    description: "Queue株式会社の個人情報保護方針（プライバシーポリシー）。",
  },
};
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "position": 2,
        "name": "個人情報保護方針",
        "item": "https://queue-tech.jp/privacy"
      }
    ]
  };
        ...
        <main className="mx-auto max-w-[800px] px-4 pt-[80px] pb-12 md:pt-[100px] md:pb-16">
          ...
          <nav className="mb-6 text-[12px] md:text-[13px] text-[#666666]" aria-label="パンくずリスト">
            <ol className="flex items-center gap-2">
              ...
              <li aria-current="page" className="text-[#333333]">個人情報保護方針</li>
            </ol>
          </nav>
