    ...
    <section className="bg-white py-28">
      <div className="mx-auto w-full max-w-[1400px] px-10 text-center">
        <p className="text-center">
          <span
            className="text-[40px] font-medium bg-clip-text text-transparent"
            style={{
          ...
          >Queue</span>
          <span
            className="text-[24px] font-bold text-[#333333]"
            style={{ fontFamily: 'var(--font-zen-kaku), sans-serif' }}
          > が選ばれる理由</span>
        </p>
        <p className="mt-6 text-[42px] font-semibold text-[#2f2f2f]">
          <span className="reason-highlight-blue">技術起点</span>
          <span className="mx-4 text-[#2f2f2f]">×</span>
        ...
        <div className="mt-16 grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            <div
              key={item.title}
              className="rounded-[12px] bg-[#f4f6fa] px-4 py-10 shadow-[0_6px_14px_rgba(0,0,0,0.06)]"
            >
              <p
                className="text-[20px] font-medium text-[#4a4a4a] whitespace-pre-line leading-[150%] tracking-[0.03em]"
                style={{ fontFamily: 'var(--font-gothic-a1), sans-serif' }}
              >
                {item.description}
              </p>
              <p className="mt-4 text-[22px] font-semibold text-[#1f5bb9]">
                {item.title}
              </p>
              <p className="mt-3 text-sm text-[#333333]">{item.subtitle}</p>
