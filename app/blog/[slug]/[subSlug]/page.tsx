      ...
      >
        <div className="mx-auto max-w-[1000px] px-4 md:px-8">
          ...
          <div className="text-center">
            <p className="text-[12px] sm:text-[14px] font-bold text-[#1f5bb9] mb-2 sm:mb-3">
              {subHub.hub?.title}
            </p>
            <h1 
      ...
      <section className="py-8 sm:py-10 md:py-16">
        <div className="mx-auto max-w-[1100px] px-4 md:px-8">
          <div className="text-center mb-6 sm:mb-10">
            ...
            <p className="mt-2 text-[13px] sm:text-[14px] font-bold text-[#333333]">記事一覧</p>
          </div>
          ...
          {posts.length > 0 ? (
            ...
            <div className="text-center py-12 sm:py-16 bg-white rounded-[12px] shadow-sm">
              <div className="w-14 h-14 sm:w-16 sm:h-16 mx-auto mb-4 rounded-full bg-[#f8f9fc] flex items-center justify-center">
