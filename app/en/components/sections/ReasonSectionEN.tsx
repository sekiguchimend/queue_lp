...
export default function ReasonSectionEN() {
  return (
      ...
      <div className="mx-auto w-full max-w-[1400px] px-4 md:px-10 text-center">
        <header className="text-center">
          ...
          <p className="mt-4 md:mt-6 text-[28px] md:text-[42px] font-medium text-[#2f2f2f] flex flex-col md:flex-row items-center justify-center">
            <span className="reason-highlight-blue">Technology-Driven</span>
            <span className="my-1 md:my-0 mx-2 md:mx-4 text-[#2f2f2f]">×</span>
            <span className="reason-highlight-purple">Implementation Power</span>
          </p>
        </header>
          ...
          {[
            {
              title: "Design",
              subtitle: "Capability",
              description: "AI search behavior-\nbased",
              ball: "/asset/reason-design.png",
            },
            {
              title: "Integrated",
              subtitle: "Design",
              description: "Prompt, structured data,\n& content",
              ball: "/asset/reason-integrated.png",
            },
            {
              title: "Verification",
              subtitle: "Process",
              description: "Real AI results,\nnot just theory",
              ball: "/asset/reason-verification.png",
            },
            {
              title: "Operations",
              subtitle: "System",
              description: "Rapid PoC →\nimprovement cycles",
