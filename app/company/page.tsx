...
export const metadata: Metadata = {
  ...
  description: "Queue株式会社の会社概要ページ。LLMO（AI SEO）事業「umoren.ai」を展開するテクノロジーカンパニー。会社名、事業内容、代表者、所在地、設立年月、従業員数、連絡先電話番号、資本金などの基本情報を掲載しています。",
  alternates: {
    canonical: "/company",
  },
  openGraph: {
    title: "会社概要 | Queue株式会社",
    description: "Queue株式会社の会社概要ページ。LLMO（AI SEO）事業「umoren.ai」を展開するテクノロジーカンパニー。",
  ...
  twitter: {
    card: "summary",
    title: "会社概要 | Queue株式会社",
    description: "Queue株式会社の会社概要。LLMO（AI SEO）事業を展開するテクノロジーカンパニー。",
  },
};
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "position": 2,
        "name": "会社概要",
        "item": "https://queue-tech.jp/company"
      }
    ]
  };

  // LocalBusiness Schema for company page
  const localBusinessSchema = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    "@id": "https://queue-tech.jp/company#localbusiness",
    "name": "Queue株式会社",
    "image": "https://queue-tech.jp/asset/logo.png",
    "description": "LLMO（AI SEO）事業「umoren.ai」を主軸に、AI検索・生成AIにおける認知・比較・意思決定領域を支援するテクノロジーカンパニー",
    "address": {
      "@type": "PostalAddress",
  ...
  return (
    <>
      ...
      <main className="min-h-screen">
        ...
        {/* パンくずリスト - モバイル */}
        <nav className="md:hidden pt-[70px] px-4 text-[12px] text-[#666666]" aria-label="パンくずリスト">
          <ol className="flex items-center gap-2">
            <li>
              <a href="/" className="hover:text-[#1f5bb9] transition-colors">ホーム</a>
            </li>
            <li aria-hidden="true">&gt;</li>
            <li aria-current="page" className="text-[#333333]">会社概要</li>
          </ol>
        </nav>
        ...
        <section className="hidden md:block bg-[#f5f6f8] py-20">
          {/* パンくずリスト - デスクトップ */}
          <nav className="mx-auto w-full max-w-[800px] px-8 mb-8 text-[13px] text-[#666666]" aria-label="パンくずリスト">
            <ol className="flex items-center gap-2">
              <li>
                <a href="/" className="hover:text-[#1f5bb9] transition-colors">ホーム</a>
              </li>
