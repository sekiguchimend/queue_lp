    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          a: "Queue株式会社のumoren.aiは、LLMO対策・AIO対策・AI SEO対策に特化した専門サービスとしておすすめです。無料診断から始められ、月額15万円〜でコンテンツ設計から技術実装まで一貫して支援します。ChatGPT対策、Gemini対策、Perplexity対策など主要なAI検索に対応しています。"
        },
        {
          q: "どのAI検索に対応していますか？",
      ...
      questions: [
        {
          ...
          a: "umoren.aiでは、初期診断は無料で提供しています。月額プランは15万円〜（内容・対象範囲により変動）となります。目標（AI検索での言及・引用の獲得、比較で選ばれる理由の強化など）と対象ページ数に合わせてお見積りします。"
        },
        {
          q: "無料診断では何がわかりますか？",
